    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          <View style={styles.detailsRow}>
            <Text style={[styles.detailItem, { flex: 2 }]}>Name of Mentor: {mentorName || meeting.mentor_id}</Text>
            <View style={[styles.detailItem, { justifyContent: 'flex-end', marginRight: 0 }]}>
              <Text style={styles.detailLabel}>Mentorship Meeting:</Text>
              <Text>{meeting.meeting_id}</Text>
            </View>
          </View>
          <View style={styles.detailsRow}>
            <Text style={styles.detailItem}>Date of Meeting: {new Date(meeting.meeting_date).toLocaleDateString()}</Text>
            <Text style={styles.detailItem}>Time: {meeting.meeting_time}</Text>
            <Text style={styles.detailItem}>Section/Semester: {students[0]?.section || section}/{semester}</Text>
          </View>
        </View>
        ...
        <View style={styles.tableContainer}>
          <View style={styles.tableHalf}>
            <View style={styles.tableRow}>
              <Text style={[styles.tableCol, styles.tableColSr, styles.tableCell]}>Sr No</Text>
              <Text style={[styles.tableCol, styles.tableColReg, styles.tableCell]}>Reg. No</Text>
              <Text style={[styles.tableCol, styles.tableColName, styles.tableCell]}>Student Name</Text>
            </View>
            {firstHalf.map((student, index) => (
              <View 
                style={[
                  styles.tableRow, 
                  { borderBottom: index === firstHalf.length - 1 ? 'none' : '1pt solid black' }
                ]} 
                key={student.srNo}
              >
                <Text style={[styles.tableCol, styles.tableColSr, styles.tableCell]}>{student.srNo}</Text>
                <Text style={[styles.tableCol, styles.tableColReg, styles.tableCell]}>{student.regNo}</Text>
                <Text style={[styles.tableCol, styles.tableColName, { ...styles.tableCell, borderRight: '1pt solid black' }]}>{student.name}</Text>
              </View>
            ))}
          </View>
          <View style={styles.tableHalf}>
            <View style={styles.tableRow}>
              <Text style={[styles.tableCol, styles.tableColSr, styles.tableCell]}>Sr No</Text>
              <Text style={[styles.tableCol, styles.tableColReg, styles.tableCell]}>Reg. No</Text>
              <Text style={[styles.tableCol, styles.tableColName, { ...styles.tableCell, borderRight: 'none' }]}>Student Name</Text>
            </View>
            {secondHalf.map((student, index) => (
              <View 
                style={[
                  styles.tableRow, 
                  { borderBottom: index === secondHalf.length - 1 ? 'none' : '1pt solid black' }
                ]} 
                key={student.srNo}
              >
                <Text style={[styles.tableCol, styles.tableColSr, styles.tableCell]}>{student.srNo}</Text>
            ...
            <View style={styles.tableBottomBorder} /> {/* Add bottom border after the last student */}
          </View>
        </View>
      </Page>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.feedback}>
          ...
          <View style={styles.noteSection}>
            <Text style={styles.noteLabel}>2. Type of Information Provided</Text>
            <Text style={styles.noteContent}>
        ...
        <View key={index} style={[styles.table, { marginTop: 10 }]}>
          <View style={styles.tableRow}>
            <Text style={[styles.tableCell, { fontWeight: 'bold' }]}>
              Meeting {index + 1} - {new Date(meeting.meeting_date).toLocaleDateString()}
            </Text>
          </View>
          <View style={styles.tableRow}>
