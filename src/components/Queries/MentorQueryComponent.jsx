      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 pt-20">
          ...
          >
            ...
            <p className="text-gray-300 mt-2">Manage and respond to mentor inquiries</p>
          </motion.div>
            ...
            <div className="bg-[#1a1a1a] p-6 rounded-lg max-w-3xl w-full">
              ...
              <div className="space-y-4">
                {queries.filter(query => query.status === selectedStatus).map(query => (
                  ...
                  >
                    <h3 className="text-xl font-semibold text-white">{query.mentor}</h3>
          ...
          >
            <div className="bg-[#1a1a1a] p-6 rounded-lg max-w-3xl w-full">
              ...
              <div className="space-y-2">
                <p className="text-white"><strong>Mentor:</strong> {selectedQuery.mentor}</p>
