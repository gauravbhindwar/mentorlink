                ...
                <table className='min-w-full table-auto border-collapse'>
                  <thead>
                    <tr className='bg-gray-100 dark:bg-gray-700'>
                      <th className='px-6 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-200 uppercase tracking-wider border-b border-gray-200 dark:border-gray-600'>
                        Name
                      </th>
                      <th className='px-6 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-200 uppercase tracking-wider border-b border-gray-200 dark:border-gray-600'>
                        Email
                  ...
                  <tbody>
                    {mentees.map((mentee, index) => (
                      <tr
                        ...
                        <td className='px-6 py-4 text-sm text-gray-700 dark:text-gray-200 border-b border-gray-200 dark:border-gray-600'>
                          {mentee.name}
                        </td>
                        <td className='px-6 py-4 text-sm text-gray-700 dark:text-gray-200 border-b border-gray-200 dark:border-gray-600'>
                          {mentee.email}
