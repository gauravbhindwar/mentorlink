...
const meetingSchema = new Schema(
  {
    ...
    semester: {
      type: Number,
      required: true,  // E.g., 1 or 2 for Semester 1 or 2
    },
    completed: {
      type: Boolean,
...
// // Method to check if a mentor has 3 meetings scheduled in a semester
// mentorSchema.methods.hasThreeMeetings = async function (semester) {
//   const meetings = await Meeting.find({
//     mentor: this._id,
//     semester: semester,
//     completed: true,  // Only count completed meetings
//   });
