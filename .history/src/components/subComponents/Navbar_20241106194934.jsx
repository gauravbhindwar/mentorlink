                ...
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            <Image src="../public/muj-logo.svg" alt="MUJ Logo" className="h-8 w-auto" width={32} height={32} />
                        ...
                        <div className="flex items-center space-x-4">
                            <Image src="C:\Users\bhind\OneDrive\Desktop\mentorlink\public\sdc-logo.jpg" alt="SDC Logo" className="h-8 w-auto" width={32} height={32} />
