...
const Navbar = () => {
    ...
    const [reportdropdownVisible, setSuperdropdownVisible] = useState(false)

    const toggleSuperDropdown = () => {
        setSuperdropdownVisible(!reportdropdownVisible)
    }
    return (
        <>
            <nav className="fixed top-0 z-50 w-full bg-white border-b max-h-[56px] min-h-[56px] border-gray-200 dark:bg-gray-800 dark:border-gray-700" >
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        ...
                        <div>
                            <div onClick={toggleSuperDropdown} className="flex items-center space-x-4">
                                <button onClick={toggleSuperDropdown} className="flex items-center text-gray-800 dark:text-white focus:outline-none">
                                    <span className="ml-2">Schedule Metting</span>
                                </button>
                            </div>
                        </div>
