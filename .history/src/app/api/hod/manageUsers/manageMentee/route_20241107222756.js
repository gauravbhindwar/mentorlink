...
export async function POST(req) {
  try {
    ...
    if (!menteePersonalDetails || !menteePersonalDetails.email) {
      return createErrorResponse("Email is required in menteePersonalDetails", 400);
    }
    ...
    console.log("New Mentee Object:", newMentee);

    // Add logging to debug the object
    if (!newMentee.menteePersonalDetails.email) {
      return createErrorResponse("Mentee email is missing", 400);
    }
