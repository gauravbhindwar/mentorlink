                ...
                <div className="relative flex flex-col md:flex-row gap-4 md:gap-6 w-full max-w-4xl mx-auto">
                    ...
                    {selectedReport === 'MOM' && (
                        <div className="flex flex-col gap-1 w-full md:w-1/4">
                            ...
                            >
                                <option value="">Select MOM Option</option>
                                <option value="MOMOption1">MOM Option 1</option>
                                <option value="MOMOption2">MOM Option 2</option>
                            </select>
                        </div>
                    )}
                    ...
                    {selectedReport === 'CONSOLIDATE' && (
                        <div className="flex flex-col gap-1 w-full md:w-1/4">
                            ...
                            <select
                                ...
                                onChange={handleSubOptionChange}
                            >
                                <option value="">Select CONSOLIDATE Option</option>
