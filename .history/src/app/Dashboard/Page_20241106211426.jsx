...
const Page = () => {
    ...
    const academicSession = ["2022-2023", "2021-2022", "2020-2021", "2019-2020"]
    const Semester = ["2022-2023", "2021-2022", "2020-2021", "2019-2020"]
    return (
        <>
            ...
            <div className='pt-[72px]'>
                <div className='top-[56px] ml-10'>
                    <div className='flex flex-row gap-4 w-1/3'>
                        ...
                        <div className='flex flex-col gap-2  '>
                            <label>Academic Session <sup style={{ color: "red" }}>*</sup></label>
                            <select className="select">
                                {academicYears.map((year, index) => (
                                    <option key={index} value={year}>{year}</option>
                                ))}
                        ...
                        <div className='flex flex-col gap-2  '>
                            <label>Semester <sup style={{ color: "red" }}>*</sup></label>
                            <select className="select">
                                {semester.map((year, index) => (
                                    <option key={index} value={year}>{year}</option>
                                ))}
                            </select>
                        </div>
